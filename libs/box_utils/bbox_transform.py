...
def rbbox_transform_1(ex_rois, gt_rois, scale_factors=None):
...
def rbbox_transform_inv_1(boxes, deltas, scale_factors=None):
    dx1 = deltas[:, 0]
    dy1 = deltas[:, 1]
    dx2 = deltas[:, 2]
    dy2 = deltas[:, 3]
...
def rbbox_transform_inv_2(boxes, deltas, scale_factors=None):
    dx1 = deltas[:, 0]
    dy1 = deltas[:, 1]
    dx2 = deltas[:, 2]
    dy2 = deltas[:, 3]
