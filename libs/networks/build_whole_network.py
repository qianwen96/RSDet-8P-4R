...
class DetectionNetwork(object):
    ...
    def rpn_reg_net(self, inputs, scope_list, reuse_flag, level):
        ...
        rpn_delta_boxes = tf.reshape(rpn_delta_boxes, [-1, 8],
                                     name='rpn_{}_regression_reshape'.format(level))   #some change from 5 to 8
            ...
            with tf.name_scope('make_anchors_all_level'):
                for level, base_anchor_size, stride in zip(level_list, cfgs.BASE_ANCHOR_SIZE_LIST, cfgs.ANCHOR_STRIDE):
                    ...
                    if self.method == 'H':
                        ...
                        # tmp_anchors = tf.reshape(tmp_anchors, [-1, 8]) 用的是h,不需要改
        ...
        #  5. build loss
            ...
            with tf.variable_scope('build_loss'):
                ...
                if cfgs.USE_IOU_FACTOR:
                    ...
                    reg_loss = losses.smooth_cl1_loss_4p_align1(target_delta, rpn_box_pred, anchor_states,anchors)
    ...
    def get_restorer(self):
        ...
        # checkpoint_path='/data/code/retina_new/model/RetinaNet_DOTA_1x_1016_4p_cl1_v2.0/DOTA_810004model.ckpt'
        # if True:
